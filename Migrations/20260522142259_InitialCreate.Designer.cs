...
namespace AppServiceAndTravel.Migrations
{
    ...
    [Migration("20260522142259_InitialCreate")]
            ...
            modelBuilder.Entity("AppServiceAndTravel.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            crypt = true,
                            fechaCambioClave = new DateTime(2026, 8, 22, 14, 22, 58, 328, DateTimeKind.Utc).AddTicks(5151),
                            fechaCreacion = new DateTime(2026, 5, 22, 14, 22, 58, 328, DateTimeKind.Utc).AddTicks(5150),
                            fechaModificacion = new DateTime(2026, 5, 22, 14, 22, 58, 328, DateTimeKind.Utc).AddTicks(5152),
                            hast = true,
            ...
            modelBuilder.Entity("AppServiceAndTravel.Models.ConfiguracionGeneral", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SeparadorMiles = ".",
                            SimboloMoneda = "$",
                            UltimaModificacion = new DateTime(2026, 5, 22, 9, 22, 58, 330, DateTimeKind.Local).AddTicks(9319),
            ...
            modelBuilder.Entity("AppServiceAndTravel.Models.Procesos", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            idProceso = 1,
                            fechaCreacion = new DateTime(2026, 5, 22, 14, 22, 58, 328, DateTimeKind.Utc).AddTicks(4679),
                            icono = "fa-gear",
                        ...
                        {
                            idProceso = 2,
                            fechaCreacion = new DateTime(2026, 5, 22, 14, 22, 58, 328, DateTimeKind.Utc).AddTicks(4688),
                            icono = "fa-shop",
                            proceso = "Productos"
                        },
                        new
                        {
                            idProceso = 3,
                            fechaCreacion = new DateTime(2026, 5, 22, 14, 22, 58, 328, DateTimeKind.Utc).AddTicks(4690),
                            icono = "fa-user",
                            idProcesoPadre = 1,
                            proceso = "Usuarios"
                        },
                        new
                        {
                            ...
                            area = "Admin",
                            controlador = "App",
                            fechaCreacion = new DateTime(2026, 5, 22, 14, 22, 58, 328, DateTimeKind.Utc).AddTicks(4691),
                            idProcesoPadre = 3,
                            proceso = "Users",
                            url = "AdminManagement"
                        },
                        new
                        {
                            ...
                            area = "Admin",
                            controlador = "App",
                            fechaCreacion = new DateTime(2026, 5, 22, 14, 22, 58, 328, DateTimeKind.Utc).AddTicks(4693),
                            idProcesoPadre = 1,
                            proceso = "Apariencia",
                            url = "Appearance"
                        },
                        new
                        {
                            ...
                            area = "Admin",
                            controlador = "App",
                            fechaCreacion = new DateTime(2026, 5, 22, 14, 22, 58, 328, DateTimeKind.Utc).AddTicks(4695),
                            idProcesoPadre = 1,
                        ...
                        new
                        {
                            ...
                            area = "Admin",
                            controlador = "App",
                            fechaCreacion = new DateTime(2026, 5, 22, 14, 22, 58, 328, DateTimeKind.Utc).AddTicks(4697),
                            idProcesoPadre = 2,
                        ...
                        new
                        {
                            ...
                            area = "Admin",
                            controlador = "App",
                            fechaCreacion = new DateTime(2026, 5, 22, 14, 22, 58, 328, DateTimeKind.Utc).AddTicks(4698),
                            idProcesoPadre = 3,
                        ...
                        new
                        {
                            ...
                            area = "Admin",
                            controlador = "App",
                            fechaCreacion = new DateTime(2026, 5, 22, 14, 22, 58, 328, DateTimeKind.Utc).AddTicks(4700),
                            idProcesoPadre = 1,
                            proceso = "Provedores",
                        ...
                        new
                        {
                            ...
                            area = "Admin",
                            controlador = "App",
                            fechaCreacion = new DateTime(2026, 5, 22, 14, 22, 58, 328, DateTimeKind.Utc).AddTicks(4701),
                            idProcesoPadre = 1,
                            proceso = "Sistema",
                        ...
                        {
                            idProceso = 11,
                            fechaCreacion = new DateTime(2026, 5, 22, 14, 22, 58, 328, DateTimeKind.Utc).AddTicks(4703),
                            icono = "fa-store",
                            proceso = "Ventas",
                            url = "Ventas"
                        },
                        new
                        {
                            idProceso = 12,
                            controlador = "Home",
                            fechaCreacion = new DateTime(2026, 5, 22, 14, 22, 58, 328, DateTimeKind.Utc).AddTicks(4704),
                            proceso = "Dashboard",
                            url = "index"
                        },
                        new
                        {
                            idProceso = 13,
                            controlador = "App",
                            fechaCreacion = new DateTime(2026, 5, 22, 14, 22, 58, 328, DateTimeKind.Utc).AddTicks(4705),
                        ...
                        new
                        {
                            idProceso = 14,
                            controlador = "App",
                            fechaCreacion = new DateTime(2026, 5, 22, 14, 22, 58, 328, DateTimeKind.Utc).AddTicks(4739),
                            icono = "fa-shop",
                            proceso = "Productos",
                            url = "Products"
                        },
                        new
                        {
                            idProceso = 15,
                            controlador = "App",
                            fechaCreacion = new DateTime(2026, 5, 22, 14, 22, 58, 328, DateTimeKind.Utc).AddTicks(4740),
                            idProcesoPadre = 14,
                            proceso = "Gestion de Productos",
                            url = "ProductsManagement"
                        },
                        new
                        {
                            idProceso = 16,
                            controlador = "App",
                            fechaCreacion = new DateTime(2026, 5, 22, 14, 22, 58, 328, DateTimeKind.Utc).AddTicks(4742),
                            idProcesoPadre = 14,
                            proceso = "Pedidos",
                            url = "Orders"
                        },
                        new
                        {
                            idProceso = 17,
                            controlador = "App",
                            fechaCreacion = new DateTime(2026, 5, 22, 14, 22, 58, 328, DateTimeKind.Utc).AddTicks(4743),
                            idProcesoPadre = 14,
            ...
            modelBuilder.Entity("AppServiceAndTravel.Models.Roles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            idRol = 1,
                            fechaCreacion = new DateTime(2026, 5, 22, 14, 22, 58, 328, DateTimeKind.Utc).AddTicks(4968),
                            fechaModificacion = new DateTime(2026, 5, 22, 14, 22, 58, 328, DateTimeKind.Utc).AddTicks(4968),
                            nombre = "Administrador"
                        },
                        new
                        {
                            idRol = 2,
                            fechaCreacion = new DateTime(2026, 5, 22, 14, 22, 58, 328, DateTimeKind.Utc).AddTicks(4973),
                            fechaModificacion = new DateTime(2026, 5, 22, 14, 22, 58, 328, DateTimeKind.Utc).AddTicks(4973),
                            nombre = "Usuarios"
                        });
                });
            ...
            modelBuilder.Entity("AppServiceAndTravel.Models.RolesUsuarios", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            idUsuario = 1,
                            idRol = 1,
                            fechaCreacion = new DateTime(2026, 5, 22, 14, 22, 58, 328, DateTimeKind.Utc).AddTicks(5058)
                        });
                });
